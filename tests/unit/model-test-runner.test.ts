...
test("resolveModelTestTimeoutMs gives ChatGPT Web checks up to 90 seconds", () => {
  assert.equal(resolveModelTestTimeoutMs("chatgpt-web", "gpt-5.6-luna-free", 30_000), 90_000);
